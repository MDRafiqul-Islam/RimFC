        ...
        <footer>
            <div class="social">
                ...
                <a href="#">
                  ...
                  <a href="{{ url('https://www.facebook.com/rafiqulislam.islam.3705/') }}"> <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="currentColor" class="bi bi-facebook" viewBox="0 0 16 16">
            ...
            <p class="copyright">RIMFC © 2021</p>
        </footer>
    </div>
