...
<div class="info">
    <a href="{{ route('user.pages.editprofile',$user->id) }}"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-gear-fill" viewBox="0 0 16 16">
...
<table id="players">
    ...
    @foreach ($fixture as $tickets)
        ...
        <tr>
            ...
            <td width="20%"> <a href="{{ route('user.pages.ticketprint', $tickets->id) }}" class="button">Show</a></td>
        </tr>
        @endif
        @endforeach
    </table>
